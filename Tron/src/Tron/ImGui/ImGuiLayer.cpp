...
namespace Tron {
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(TN_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
		...
		dispatcher.Dispatch<WindowResizeEvent>(TN_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
